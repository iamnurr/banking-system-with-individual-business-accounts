    ...
    <div>
        ...
        <div
            ...
            <div class="w-full mt-20 max-w-screen-lg mx-auto p-4">
                ...
                <h2 class="text-white text-lg">{{("Transactions")}}</h2>
                <table class="min-w-full border border-gray-300 divide-y divide-gray-300">
                    <thead class="bg-gray-100">
                        <tr>
                            <th class="py-2 px-4 text-left">{{ __("Transaction Type") }}</th>
                    ...
                    <tbody>
                        ...
                        <tr class="">
                            <td class="py-2 px-4 text-white">{{ get_transaction_types($deposit->transaction_type) }}
                            </td>
